...
# Define RuleService class - always available
class RuleService(rules_pb2_grpc.RuleServiceServicer if rules_pb2 is not None else object):
    ...
    async def CreateRule(self, request, context):
        """Create a new rule"""
        if rules_pb2 is None:
            logger.error("Proto files not available - CreateRule not functional")
            return None
    ...
    async def UpdateRule(self, request, context):
        ...
        if rules_pb2 is None:
            logger.error("Proto files not available - UpdateRule not functional")
            return None
    ...
    async def GetRule(self, request, context):
        """Get a specific rule by ID"""
        if rules_pb2 is None:
            logger.error("Proto files not available - GetRule not functional")
            return None
    ...
    async def ListRules(self, request, context):
        ...
        if rules_pb2 is None:
            logger.error("Proto files not available - ListRules not functional")
            return None
    ...
    async def DeleteRule(self, request, context):
        """Delete a rule by ID"""
        if rules_pb2 is None:
            logger.error("Proto files not available - DeleteRule not functional")
            return None
    ...
    async def EvaluateRules(self, request, context):
        ...
        if rules_pb2 is None:
            logger.error("Proto files not available - EvaluateRules not functional")
            return None
